...
switch($_GET['funcion']) {
 ...
 function preguntas($nombreEnfermedad){
    ...
    $command= `swipl -s C:\Users\MT\IdeaProjects\prologFinal_JAVAPHP\prolog.pl -g "enfermedad_sintoma($nombreEnfermedad). -t 'halt'"`;
 ...
 function insertarEnfermedad($nombreEnfermedad){
	echo $nombreEnfermedad;
	//$preguntas = 'C:\progra~2\swipl\bin\swipl.exe -s C:\Users\MT\IdeaProjects\prologFinal\prolog.pl -g test,halt';
    $command= `swipl -s C:\Users\MT\IdeaProjects\prologFinal_JAVAPHP\prolog.pl -g "insertarEnfermedad($nombreEnfermedad)). -t 'halt'"`;
	exec($command, $preguntas);
	echo "INSERTADO";
